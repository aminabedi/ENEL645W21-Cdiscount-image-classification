...
monitor = tf.keras.callbacks.ModelCheckpoint(model_name_cnn, monitor='val_loss',                                             verbose=0,save_best_only=True,                                             save_weights_only=True,                                             mode='min')
...
model.fit(X_train,Y_train,batch_size = 16, epochs = 150,           verbose = 1, callbacks= [early_stop, monitor, lr_schedule],validation_data=(X_val,Y_val))
